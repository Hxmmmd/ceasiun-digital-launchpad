...
const subserviceGoals: Record<string, { question: string; goals: string[] }> = {
  ...
  "DevOps": { question: "What are you looking to achieve with DevOps support?", goals: ["Improve deployment processes", "Automate CI/CD", "Improve infrastructure reliability", "Improve monitoring", "Deploy faster", "Reduce operational overhead", "Other"] },
  "Full System Administration": { question: "What do you need help with in system administration?", goals: ["Manage servers", "Maintain systems", "Manage users and access", "Improve monitoring", "Manage backups", "Improve infrastructure security", "Other"] },
  "Network Administration": { question: "What do you need help with in your network environment?", goals: ["Set up a network", "Manage network infrastructure", "Improve monitoring", "Troubleshoot issues", "Improve network performance", "Improve network security", "Other"] },
};
